...
ggplot(df, aes(x = time, y = Threshold, color = var)) + 
  geom_line() + 
  geom_vline(xintercept = as.numeric(1426300242), color = "red", linetype="dotted") + 
  geom_vline(xintercept = as.numeric(1426300252), color = "green", linetype="dotted") + 
...
ggplot(partA, aes(x = time, y = Threshold)) + 
  ...
  geom_vline(xintercept = as.numeric(1426301657), color = "red", linetype="dotted") + 
  geom_vline(xintercept = as.numeric(1426301667), color = "green", linetype="dotted") + 
  theme(legend.title=element_blank()) + 
...
ggplot(partA, aes(x = time, y = Threshold, colour = Anomaly)) +
  geom_point() + 
  geom_vline(xintercept = 1426301836, color = "red", linetype="dotted") +
  geom_vline(xintercept = 1426301846, color = "green", linetype="dotted")
